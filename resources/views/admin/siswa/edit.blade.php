                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name',$siswa->name) }}" placeholder="Masukkan Nama SISWA"
                            ...
                            <div class="form-group">
                                <label>EMAIL</label>
                                <input type="email" name="email" value="{{ old('email',$siswa->email) }}" placeholder="Masukkan Email"
                            ...
                            <div class="form-group">
                                <label>PHONE</label>
                                <input type="tel" name="phone" value="{{ old('phone',$siswa->phone) }}" placeholder="Masukkan Phone"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat" id="" class="form-control @error('alamat') is-invalid @enderror" cols="30" placeholder="Masukan Alamat" rows="10">{{ old('alamat',$siswa->alamat) }}
                                </textarea>
                                @error('alamat')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
